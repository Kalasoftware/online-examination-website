...
// Get exam details without teacher restriction
$stmt = $db->prepare("
    SELECT e.*, 
           COALESCE(u.name, 'Admin') as teacher_name,
           (SELECT COUNT(*) FROM exam_registrations er WHERE er.exam_id = e.exam_id) as total_registered,
           (SELECT COUNT(*) FROM results r 
            WHERE r.exam_id = e.exam_id AND r.marks_obtained IS NOT NULL) as total_completed,
           CASE 
...
// Update the status display with dynamic styling
$status_color = [
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600">Teacher: {$exam['teacher_name']}</p>
            </div>
