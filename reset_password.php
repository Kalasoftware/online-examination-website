...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Verify if email exists and belongs to a teacher
    $stmt = $db->prepare("SELECT * FROM users WHERE email = ? AND role = 'TEACHER'");
    $stmt->execute([$email]);
    ...
    if ($user) {
        ...
        $error = "No teacher account found with this email address.";
    }
}
?>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-md w-96">
            <div class="text-center mb-6">
                ...
                <h1 class="text-2xl font-bold">Reset Teacher Password</h1>
            </div>
